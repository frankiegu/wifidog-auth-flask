...
class TestSite(unittest.TestCase):
    ...
    def test_wifidog_login_get(self):
        ...
        self.assertEquals('192.168.0.1', d('[name=gw_address]').val())
        self.assertEquals('8080', d('[name=gw_port]').val())
        self.assertEquals('main-gateway1', d('[name=gateway_id]').val())
        self.assertEquals('00:00:00:00:00:00', d('[name=mac]').val())
        self.assertEquals('http://example.com', d('[name=url]').val())
    ...
    def test_wifidog_login_post(self):
        ...
        self.assertEquals('http://192.168.0.1:8080/wifidog/auth/?token=%s' % voucher.token, response.headers['Location'])
    ...
    def test_wifidog_auth_with_ended(self):
    ...
    def test_wifidog_auth_with_expired(self):
